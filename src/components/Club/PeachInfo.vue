    ...
    <div class="header-section" v-if="battleInfo">
      <div class="club-vs-container">
        ...
        <div class="club-info own">
          <n-avatar round :size="80" :src="battleInfo.ownClub?.logo || '/icons/logo.png'" class="club-logo" />
        ...
        <div class="club-info opponent">
          <n-avatar round :size="80" :src="battleInfo.opponentClub?.logo || '/icons/logo.png'" class="club-logo" />
          <div class="club-details">
